...
class Fluidflow3D(torch.utils.data.Dataset):
    def __init__(self, root='../GotFlow3D/data/training_set2/FluidFlow3D-norm/', npoints=2048, partition='train'):
        ...
        self.cache = {}
        self.cache_size = 30000  # 40000 34427
    ...
    def __getitem__(self, index):
        ...
        # # 归一化处理
        # pos1 = normalize(pos1, 0, 16)
        # pos2 = normalize(pos2, 0, 16)
        # flow = normalize(flow, -1, 1)
...
class Fluidflow3D_eval(torch.utils.data.Dataset):
